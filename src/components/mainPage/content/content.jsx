...
const onClickRadioOne = () => { 
    setActiveStep(1);  
};

const onClickRadioTwo = () => { 
    setActiveStep(2);  
};

const onClickRadioThri = () => { 
    setActiveStep(3);  
};
            ...
            <div className={styles.container}>
                <div className={styles.boxBar}>
                    <div className={styles.border}>
                            <div onClick={onClickRadioOne} className={classnames(styles.barCircle,  {
                                [styles.activeBarCircle]: activeStep >= 1,
                            })}></div>
                            <div onClick={onClickRadioTwo} className={classnames(styles.barCircle,  {
                                [styles.activeBarCircle]: activeStep >= 2 
                            })}></div>
                            <div onClick={onClickRadioThri} className={classnames(styles.barCircle,  {
                                [styles.activeBarCircle]: activeStep >= 3 
                            })}></div>
                            <div className={styles.greyLine}></div>
                            <div className={classnames(styles.greenLine, {
                                 [styles.activeGreenLineOne]: activeStep >= 1,

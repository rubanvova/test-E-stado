...
import { FirstStep, SecondStep, ThirdStep, FifthStep } from "./steps";
        ...
        <div className={styles.boxBar}>
          <div className={styles.border}>
            <div
              ...
              className={classnames(styles.barCircle, {
            ...
            <div
              className={classnames(styles.greenLine, {
